...
public class ListarEnderecos extends javax.swing.JFrame {
   public void tabelarEnderecos(){
        ...
        //do objeto enderecosDAO nos seus campos separados por vírgula.
        for(Enderecos enderecosDAO: lista){ //este é um exemplo de uso do for-each
            tabela.addRow(new Object[]{ //este Object é um vetor/array
            enderecosDAO.getId(),
            enderecosDAO.getCep(),
            enderecosDAO.getRua(),
            enderecosDAO.getNumero(),
            enderecosDAO.getComplemento(),
            enderecosDAO.getBairro(),
            enderecosDAO.getCidade(),
            enderecosDAO.getUF()
            } );
        }
    ...
    /**
     * Creates new form ListarEnderecos
     */
    ...
    private void initComponents() {
        ...
        jTableEnderecos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Cep", "Rua", "Numero", "Comp", "Bairro", "Cidade", "uf"
            }
        ));
